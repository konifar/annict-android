...
@Singleton public class ProgramRepositoryImpl implements ProgramRepository {

  private final AnnictClient client;

  private final Context context;

  @Inject public ProgramRepositoryImpl(AnnictClient client, Context context) {
    this.client = client;
  ...
  @Override public Observable<List<Program>> getMineOrderByStartedAtDesc(int page) {
