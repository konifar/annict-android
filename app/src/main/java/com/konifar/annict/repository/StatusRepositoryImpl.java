...
@Singleton public class StatusRepositoryImpl implements StatusRepository {

  private final AnnictClient client;

  @Inject public StatusRepositoryImpl(AnnictClient client) {
    this.client = client;
  }

  @Override public Observable<Void> edit(long workId, Status status) {
