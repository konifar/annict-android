...
@Singleton public class WorkRepositoryImpl implements WorkRepository {

  private final AnnictClient client;

  private final Context context;

  @Inject public WorkRepositoryImpl(AnnictClient client, Context context) {
    this.client = client;
    this.context = context;
  }

  @Override public Observable<List<Work>> getMineWhereStatusWithAuth(String authCode, Status status,
      int page) {
  ...
  @Override public Observable<List<Work>> getMineWhereStatus(Status status, int page) {
  ...
  @Override public Observable<List<Work>> getWhereSeason(String season, int page) {
  ...
  @Override public Observable<List<Work>> getOrderWatchersCountDesc(int page) {
