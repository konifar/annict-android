...
@Singleton public class AnnictClient {
  ...
  @Inject public AnnictClient(OkHttpClient client) {
  ...
  public interface AnnictService {
     ...
     */
    @POST("/oauth/token") Observable<Token> postOauthToken(@Query("client_id") String clientId,
     ...
     */
    @GET("/v1/me/programs") Observable<Programs> getMeProgarms(
     ...
     */
    @GET("/v1/me/works") Observable<Works> getMeWorks(@Query("fields") @Nullable String fields,
     ...
     */
    @POST("/v1/me/statuses") Observable<Void> postMeStatuses(@Query("work_id") long workId,
        @Query("kind") @NonNull String kind);

    /**
     * https://annict.wikihub.io/wiki/api/works
     */
    @GET("/v1/works") Observable<Works> getWorks(@Query("fields") @Nullable String fields,
        @Query("filter_ids") @Nullable String filterIds,
        @Query("filter_season") @Nullable String filterSeason,
