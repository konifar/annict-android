...
public class DateUtil {
  ...
  @NonNull public static String getMonthDate(Date date, Context context) {
  ...
  @NonNull public static String getHourMinute(Date date) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
  ...
  @NonNull public static String getLongFormatDate(@Nullable Date date) {
    if (date == null) return "";
  ...
  @NonNull public static String getProgramStartDate(@Nullable Date date) {
    if (date != null) {
